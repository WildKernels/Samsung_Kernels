...
// Store 10 data readings for Heatmap logging
#if defined(CONFIG_SEC_HEATMAP_LOGGING)
#define HMAP_BUFFER_SIZE 10 
#endif
...
struct sec_battery_info {
	...
	/* create buffer of data related to heatmap service */
#if defined(CONFIG_SEC_HEATMAP_LOGGING)
	struct sec_battery_hmap_data *hmap_buffer;
	int hmap_buffer_index;
	bool hmap_buffer_full;
	bool is_ect_enabled;

	struct delayed_work sec_hmap_logging_work;
#endif
