...
#define SMP2P_WAKELOCK_DURATION_MAX	50000	//50s
...
enum {
	...
	OPTION_TYPE_SSC_ONESHOT_CRASH_IDX,   // for device mode
	OPTION_TYPE_SSC_FORCE_CRASH,         // for commoninfo
	OPTION_TYPE_SSC_MAX
};
