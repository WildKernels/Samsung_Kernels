...
#define AP_WAKE_INIT			-1
#define AP_WAKE_NONE			0
#define AP_WAKE_NO_FW_PDIC		1 /* For PD communication for no fw models */
#define AP_WAKE_DAEMON_MONITOR	2 /* For daemons that monitor battery information */
