...
$(warning RECOVERY mode configs : S.LSI model: BOARD_INCLUDE_RECOVERY_RAMDISK_IN_VENDOR_BOOT is not set )
...
ifeq ($(AB_OTA_UPDATER), true)
TARGET_RECOVERY_FSTAB := device/samsung/common/recovery/recovery.fstab.s5e9945.ab
else
# non-AB model
...
SCSC_WLAN_DEVICE_NAME            := redwood_s640
endif
