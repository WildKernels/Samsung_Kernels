...
class Platform {
  ...
  public:
    ...
    android::SimpleLog mTranslationModeLog{10};
    bool mLastTranslationMode{false};
#endif
...
#ifdef SEC_AUDIO_ADD_FOR_DEBUG
    void updateTranslationMode(const char *caller, bool mode, int ret);
#endif
...
#endif
#ifdef SEC_AUDIO_SUPPORT_AURACAST_REMOTE_MIC
    void setArmEnabled(const bool enable) { mArmEnabled = enable; }
    bool isArmEnabled() const { return mArmEnabled; }
#endif
#ifdef SEC_AUDIO_SUPPORT_AFE_LISTENBACK
